    ...
    <div className={styles.mainContainer}>
      <div className={styles.hero}>
        <div className="container">
          <span className={styles.heroBadge}>Scientific Contributions</span>
          <h1>Research <span>Publications</span></h1>
          <p>Explore the comprehensive repository of publications, clinical trials, and academic papers from our institute.</p>
        </div>
      </div>
        ...
        <div className="container">
          <div className={styles.statsBar}>
            <div className={styles.statItem}>
              <span className={styles.statVal}>{publicationData.length}+</span>
            ...
            <div className={styles.statItem}>
              ...
              <span className={styles.statLbl}>Institution Support</span>
            </div>
          </div>
